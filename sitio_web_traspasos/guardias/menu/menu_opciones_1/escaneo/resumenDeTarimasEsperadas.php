...
if ($consulta = mysqli_query($conexion, $query)) {
    ...
    $string_table.= "<thead>";
    $string_table.= "<tr>";
    $string_table.= "<th class='text-center'>Clave de Producto</th>";
    $string_table.= "<th class='text-center'>Nombre de Producto</th>";
    $string_table.= "<th class='text-center'>Tarimas</th>";
    $string_table.= "</tr>";
    $string_table.= "</thead>";
    $string_table.= "</table>";
    $string_table.= "</div>";
